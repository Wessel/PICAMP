...
FINAL_IMAGE=${DISTDIR}/picamp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/picamp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
# Subprojects
.build-subprojects:
	cd ../picamp-rotary.X && ${MAKE}  -f Makefile CONF=default
	cd ../picamp-potentiometer.X && ${MAKE}  -f Makefile CONF=default


# Subprojects
.clean-subprojects:
	cd ../picamp-rotary.X && rm -rf "build/default" "dist/default"
	cd ../picamp-potentiometer.X && rm -rf "build/default" "dist/default"
