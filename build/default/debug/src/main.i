...
# 1 "src/../include/initialisation.h" 1
# 13 "src/../include/initialisation.h"
...
# 1 "src/../include/rotary_encoder.h" 1
...
# 1 "src/../include/potentiometer.h" 1
...
void pic_init(void) {
  ...
  ADCConfig adc_config = { ADC_ON, ADC_RIGHT, ADC_AN07, ADC_FOSC02, VREF_PLUSPIN, VREF_MINPIN, ADC_IN_PROGRESS };
...
void __attribute__((picinterrupt(("")))) isr(void) {
  if (INTCONbits.RBIF == 1) {
    ...
    parse_rotary(PORTBbits.RB4, PORTBbits.RB5, &count, 4, 0);
